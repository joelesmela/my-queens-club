      ...
      <div className='container'>
        <div className='row'>
          <div className='col-lg-6 col-md-12 col-12 mb-4 d-flex justify-content-center'>
            <div className='w-75'>
              <h4 className='text-white m-3 text-center'>Suscríbete</h4>
              <p className={`text-white mt-2 ${styles.text}`}>Reciba mensualmente todas las novedades de nuestras modelos directamente en su bandeja de entrada. También obtendrás ofertas exclusivas sólo disponibles a través de nuestros boletines.</p>
              <form>
        ...
        <div className='row'>
          <div className='col-lg-6 col-md-12 py-3'>
            <p className='text-center text-white m-0'>My Queens Club - Todos los derechos reservados © 2022</p>
          </div>
          <div className='col-lg-6 col-md-12 py-3'>
            <p className='text-center text-white m-0'>Sitio web realizado por <a href="https://www.lagerdevs.com/" className={`text-decoration-none ${styles.condition}`}>Lager Devs</a></p>
          </div>
        </div>
      </div>
    </footer>
