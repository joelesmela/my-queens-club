    ...
    <div className={styles.bgHome}>
      ...
      <header>
        ...
        <div className='pt-5 pb-4'>
          ...
          <h6 className={`fw-bolder text-center mb-4 ${styles.subTitle}`}>Galeria de fotos de {queenName}</h6>
        </div>
      </header>
            ...
            images.map((src, i) => (
              <div key={i} className="mb-3 position-relative">
                ...
                <div className={`w-100 position-absolute top-50 start-50 translate-middle text-center ${styles.textColor} ${i !== (images.length - 1) ? 'visually-hidden' : null}`}>
                  ...
                  <div className='my-4'>
                    <button className={`px-5 btn ${styles.button}`}>Suscribete</button>
                  </div>
                  <p>
                    <em>Precio final de la galeria AR${price}</em>
                  </p>
                  <p>Si ya tenes una suscripción a esta galeria,
                  inicia sesión para poder visualizarla. </p>
                  <div className='my-4'>
                    <button className={`btn ${styles.outlineButton} btn-outline-dark`}>Iniciar sesion</button>
                  </div>
                </div>
              </div>
            ))
